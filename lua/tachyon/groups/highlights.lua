...
function M.highlight(aspects, opts)
	local background = aspects.none
	local background1 = aspects.none
	local dim_bg = aspects.none
	local cursor_bg = aspects.bg1
	...
	return {
		...
		SpecialComment = vim.tbl_extend("force", { fg = aspects.bg6 }, opts.styles.comments),
